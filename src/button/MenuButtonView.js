...
export default class MenuButtonView extends Component {
    ...
    render() {
        ...
        let text = data.name;
        let deleteImage = menuButtonDeleteImage !== null ? menuButtonDeleteImage : <Image style={{ width : 30, height : 30, position : 'absolute', right : 5, top : 0 }} source={require('./delete.png')}/>;
