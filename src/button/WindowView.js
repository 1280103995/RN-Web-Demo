    ...
    return dots.map((item, key) => {
      ...
      return (
        ...
        <View style={{
          ...
          width: 6,
          borderRadius: 3,
          backgroundColor: key === this.state.currentPage ? 'rgba(255,255,255,1.0)' : 'rgba(255,255,255,0.5)',
          marginHorizontal: 3,
        }} key={key}/>
      );
    });
  ...
  render() {
    return (
      <View style={{
        ...
        width: this.props.contentRange.width,
        height: this.props.contentRange.height,
        ...
        {this.renderMenuView()}
        <Animated.Text style={[styles.titleStyle, this.props.titleStyle, {
          width: this.props.contentRange.width,
          top: (this.props.contentRange.height - this.props.height) / 2 - 50,
          left: 0,
          opacity: this.state.bgColorOp,
          fontSize: this.scaleFontSize(25),
        }]}>
          {this.props.title}
        </Animated.Text>
      </View>
